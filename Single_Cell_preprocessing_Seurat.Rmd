---
title: "Miranda sample preprocessing"
...
```{r}
results$summary %>% as.data.frame %>% writexl::write_xlsx("doubletInfo_Miranda.xlsx")
```
...
```{r}
saveRDS(Merged_raw_object, "/home/mhassan/R_Projects/Multiome/Miranda/Merged_raw_object.RDS")
```
